...
class Controller(torch.nn.Module):
    ...
    def __init__(self, backbone_input_dim,hidden_dim,output_dim,factor_num,riemannian_component):
        ...
        self.riemannian_component=riemannian_component
        ...
        self.predictor3 = nn.Linear(hidden_dim,self.riemannian_component)
    ...
    def forward(self, mean_proto_category, all_data):
        ...
        output10=(F.sigmoid(output9)-0.5)*2
